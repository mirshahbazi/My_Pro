...
//        mOkHttpClient.setConnectTimeout(30, TimeUnit.SECONDS);
    ...
    /**
     * @Title: getIncludeParamters
     * @Description: get同步网络请求，包含参数
     * @Params: HashMap<Object,Object> String
     * @Data: 2017/2/20 16:19
     * @Author: 李鹏鹏
     */
    public static String getIncludeParams(HashMap<String, String> params, String url) {
        ...
        try {
            ...
            for (String key : params.keySet()) {
                ...
                //对参数进行URLEncoder
                paramsStr.append(String.format("%s=%s", key, URLEncoder.encode(params.get(key), "utf-8")));
                pos++;
            }
            String requestUrl=String.format("%s?%s",url,paramsStr.toString());
            Request request = new Request.Builder().get().url(requestUrl).build();
            response = execute(request);
            return response.body().string();
        } catch (IOException e) {
            Log.i("test", "net wrong");
        }
        return null;
    }

    /**
    * @Title: putIncludeParamters
    * @Description: 同步put网络请求，包含参数
    * @Params: String  HashMap<String,String>
    * @Data: 2017/2/21 10:39
    * @Author: 李鹏鹏
    */
    public static String putIncludeParams(String url,HashMap<String,String> params){
        String jsonStr=GsonUtil.parseMapToJson(params);
    ...
    /**
    * @Title: deleteIncludeParams
    * @Description: 同步delete网络请求，包含参数
    * @Params: String  HashMap<String,String>
    * @Data: 2017/2/21 10:40
    * @Author: 李鹏鹏
    */
    public static String deleteIncludeParams(String url,HashMap<String,String> params){
        String jsonStr=GsonUtil.parseMapToJson(params);
        RequestBody body=RequestBody.create(MediaType.parse("application/json; charset=utf-8"), jsonStr);
