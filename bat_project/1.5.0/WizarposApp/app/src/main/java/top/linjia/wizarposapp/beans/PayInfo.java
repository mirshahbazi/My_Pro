...
public class PayInfo {
    ...
    private boolean ifLinjiaMoney;

    public boolean isIfLinjiaMoney() {
        return ifLinjiaMoney;
    }

    public void setIfLinjiaMoney(boolean ifLinjiaMoney) {
        this.ifLinjiaMoney = ifLinjiaMoney;
    }
