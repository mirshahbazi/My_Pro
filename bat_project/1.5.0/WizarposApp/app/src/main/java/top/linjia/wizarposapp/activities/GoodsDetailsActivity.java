        ...
        handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                if (goodsDetails.getResult().getNumber() < goodsDetails.getResult().getMoq()) {
                    ...
                    activityGoodsDetailsCartnum.setBackgroundResource(R.mipmap.goods_details_num_grey);
                    activityGoodsDetailsCartreduce.setBackgroundResource(R.mipmap.substract_grey);
                    activityGoodsDetailsCartplus.setBackgroundResource(R.mipmap.add_grey);
                ...
                goodsdetails_couponinfo.getBackground().setAlpha(200);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.activity_goods_details_cartreduce:
                if (!lock) {
                    MyToast.showToast(GoodsDetailsActivity.this, this.getString(R.string.not_click));
                    return;
                }
                lock = false;
            ...
            case R.id.activity_goods_details_cartadd:
                 ...
                 * */
                if (store == 0) {
                    MyToast.showToast(GoodsDetailsActivity.this, getResources().getString(R.string.goods_purchase_supplenum));
                    return;
                }
                if (!lock) {
                    MyToast.showToast(GoodsDetailsActivity.this, this.getString(R.string.not_click));
    ...
    private void upUI(final String msg) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                go_cart.setText(getResources().getString(R.string.go_cart) + "(" + String.valueOf(WizarPosApp.getmPersonalInfo().getCartGoodsNum()) + ")");
                if (msg != null) {
                    MyToast.showToast(GoodsDetailsActivity.this, msg);
                }
                if (upCartNumberBean.getState() != 0) {
