...
public class SelectPayDialog extends Dialog implements View.OnClickListener {
    ...
    private TextView mUltimatelyPayText;
    ...
    public String getmUltimatelyPayTextContent() {
        return mUltimatelyPayText.getText().toString();
    }

    public void setmUltimatelyPayTextContent(String mUltimatelyPayText) {
        this.mUltimatelyPayText.setText(mUltimatelyPayText);
    }
    ...
    private void initView() {
        ...
        mUltimatelyPayText = (TextView) findViewById(R.id.ultimately_pay_text);
