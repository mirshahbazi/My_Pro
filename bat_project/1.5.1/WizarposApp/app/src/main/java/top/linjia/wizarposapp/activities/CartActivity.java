...
public class CartActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TitleFragment mCartActivityTitleFragment;
    ...
    private void initView() {
        ...
        mCartActivityTitleFragment = (TitleFragment) getFragmentManager().findFragmentById(R.id.cart_activity_title_fragment);
        mCartActivityTitleFragment.thisWhereActivity(TitleFragment.ORDER_FORM);
