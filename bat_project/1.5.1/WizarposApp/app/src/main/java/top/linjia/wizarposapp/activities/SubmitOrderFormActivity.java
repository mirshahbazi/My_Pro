...
import top.linjia.wizarposapp.adapters.SubmitActivityGoodsAdapter;
...
public class SubmitOrderFormActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView mActivitySubmitOrderFormStore;
    ...
    private SubmitActivityGoodsAdapter submitActivityGoodsAdapter;//适配器
    ...
    private View mActivityCommitGoodsTitle;
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case MSG_WHAT_CART_INIT://没有订单号码时候的更新ui
                        ...
                        mActivitySubmitOrderFormLinjiaCoinsUse.setText("￥" + String.valueOf(df2.format(sob.getResult().getPayBylinjiaMoney())));
                        mCommitOrderFormTotalmoneyNumber.setText("￥" + String.valueOf(df2.format(money)));
                        mCommitPaymentMoney.setText("￥" + String.valueOf(df2.format(payMoney)));
                        mCommitOrderFormFreightNumber.setText("￥" + String.valueOf(df2.format(sendMoney)));
                        break;
                    case MSG_WHAT_ORDER_INIT:
                        ...
                        mCommitOrderFormTotalmoneyNumber.setText("￥" + String.valueOf(df2.format(money)));//总额
                        mCommitPaymentMoney.setText("￥" + String.valueOf(df2.format(payMoney)));//实付
                        mCommitOrderFormFreightNumber.setText("￥" + String.valueOf(df2.format(sendMoney)));//运费
    ...
    private void initView() {
         ...
         * 店家信息
         * */
        mActivitySubmitOrderFormStore = (TextView) mHeaderView.findViewById(R.id.activity_submit_order_form_store);
        mActivitySubmitOrderFormStore.setOnClickListener(this);
        ...
        mActivitySubmitOrderFormStore.setEllipsize(TextUtils.TruncateAt.valueOf("END"));
    ...
    private void initListView(double ljcoins) {
        ...
        mActivityCommitGoodsTitle = (View) findViewById(R.id.activity_commit_goods_title);  //商品名称，单价，操作标题栏
        ...
        if (payGoodsList == null) {
            submitActivityGoodsAdapter = new SubmitActivityGoodsAdapter(mActivitySubmitOrderFormCouponShow, areaForCouponShow, mCommitOrderFormTotalmoneyNumber, mCommitOrderFormFreightNumber, mCommitPaymentMoney,
        ...
        mActivityCommitOrderformList.setAdapter(submitActivityGoodsAdapter);
    ...
    private void compatibilityInitView() {
        if (isPay) {
            ...
            submitActivityGoodsAdapter.setShowOperation(false);
             ...
             * */
            submitActivityGoodsAdapter.setShowOperation(true);
        }
        submitActivityGoodsAdapter.notifyDataSetChanged();
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.commit_payment_btn:
                submit();
                break;
            case R.id.activity_submit_order_form_store:
                intent = new Intent(SubmitOrderFormActivity.this, PersonAddressActivity.class);
            ...
            case R.id.submitActivity_textview_coupon_more:
                intent = new Intent(this, CouponShowActivtiy.class);
    ...
    private void commitOrderForm() {
        ...
        String consignee = WizarPosApp.getmPersonalInfo().getResult().getUname();
        String phone = WizarPosApp.getmPersonalInfo().getResult().getPhone();
        String address = WizarPosApp.getmPersonalInfo().getResult().getAddress();
            ...
            for (int i = 0; i < map.size(); i++) {
                ...
                if (map.containsKey(COUPON_SHOP)) {
                    ...
                    while (iter.hasNext()) {
                        ...
                        TextView textView = (TextView) tv.findViewById(R.id.coupon_pic_classify_info);
                        textView.setText(point + "元购物券*" + num);
                ...
                if (map.containsKey(COUPON_OFFSET)) {
                    ...
                    for (int j = 0; j < offsetmap.size(); j++) {
                        ...
                        while (iter.hasNext()) {
                            ...
                            View tv = LayoutInflater.from(context).inflate(R.layout.submitactivity_coupon_pic, null);
                            TextView textView = (TextView) tv.findViewById(R.id.coupon_pic_classify_info);
                            textView.setText(point + "元抵用券*" + num);
                            mActivitySubmitOrderFormCouponShow.addView(tv);
                            /*TextView numView = (TextView) tv.findViewById(R.id.coupon_pic_num);
                            TextView valueView = (TextView) tv.findViewById(R.id.coupon_pic_value);
                            mActivitySubmitOrderFormCouponShow.addView(tv);
                        ...
                        if (sacc != null) {
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    builder.append(df2.format(favorableMoney.doubleValue() < 0 ? 0 : favorableMoney.doubleValue()));
                                    mSubmitFavorable.setText(builder);
                                    mCommitPaymentMoney.setText(SubmitOrderFormActivity.this.getString(R.string.fragmentCard_renminbi) + String.valueOf(df2.format(sacc.getResult().getPayMoney())));
                    ...
                    try {
                        ...
                        if (sob != null) {
                            ...
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    mCommitPaymentMoney.setText(SubmitOrderFormActivity.this.getString(R.string.fragmentCard_renminbi) + String.valueOf(df2.format(sob.getResult().getPayMoney())));
                                    payMoney = sob.getResult().getPayMoney();
