...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        mMainVersion = (TextView) findViewById(R.id.main_version);

        /**
         * 赋值
         */
        mMainVersion.setText(GetSystemInfoUtil.getThisVersionNumber(this));
        CartNumberHelper.computerCartSum(main_cartnum,WizarPosApp.getmPersonalInfo().getCartGoodsNum());
