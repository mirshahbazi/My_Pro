            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case MSG_WHAT_CART_INIT:
                        ...
                        mCommitOrderFormTotalmoneyNumber.setText(String.valueOf(sob.getResult().getMoney()));
                        mCommitPaymentMoney.setText(String.valueOf(sob.getResult().getPayMoney()));
                        mCommitOrderFormFreightNumber.setText(String.valueOf(sob.getResult().getSendMoney()));
                    ...
                    case MSG_WHAT_ORDER_INIT:
                        ...
                        mCommitOrderFormTotalmoneyNumber.setText(String.valueOf(submitActCouCoinBean.getResult().getMoney()));
                        mCommitPaymentMoney.setText(String.valueOf(submitActCouCoinBean.getResult().getPayMoney()));
                        mCommitOrderFormFreightNumber.setText(String.valueOf(submitActCouCoinBean.getResult().getSendMoney()));
    ...
    private void initListView(double ljcoins) {
        ...
        if (payGoodsList == null) {
            submitActivityGoodsListAdapter = new SubmitActivityGoodsListAdapter(mActivitySubmitOrderFormCouponShow, areaForCouponShow, mCommitOrderFormTotalmoneyNumber, mCommitOrderFormFreightNumber, mCommitPaymentMoney,
                    new CheckBox(this), this, new ArrayList<CartGoodsbean.ResultBean>(), totalMoney, couponType, couponNum, couponValue, mActivitySubmitOrderFormLinjiaCoinsUse, payMoney);
        } else {
            submitActivityGoodsListAdapter = new SubmitActivityGoodsListAdapter(mActivitySubmitOrderFormCouponShow, areaForCouponShow, mCommitOrderFormTotalmoneyNumber, mCommitOrderFormFreightNumber, mCommitPaymentMoney,
                    new CheckBox(this), this, payGoodsList, totalMoney, couponType, couponNum, couponValue, mActivitySubmitOrderFormLinjiaCoinsUse, payMoney);
        }
...
//                String resultFormat = extras.getString(DecodeResult.RESULT_FORMAT);//获取解码类型 如QE_CODE
     ...
     * @Description: TODO 向后台请求进行支付，支付成功后进行跳转提示
     ...
     * @Description: TODO 将商品的id和数量过滤出来
