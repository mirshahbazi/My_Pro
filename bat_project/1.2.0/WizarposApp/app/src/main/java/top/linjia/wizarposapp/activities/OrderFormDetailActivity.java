                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if (orderFromDetail.getResult().getStatus() == 2) {
                                    ...
                                    final List<CartGoodsbean.ResultBean> list = new ArrayList<>();
                                    for (int i = 0; i < orderFromDetail.getResult().getDetails().size(); i++) {
                                        ...
                                        resultBean.setName(orderFromDetail.getResult().getDetails().get(i).getGoodsName());
                                        Log.i("test", i + orderFromDetail.getResult().getDetails().get(i).getGoodsName());
                                        resultBean.setStname(orderFromDetail.getResult().getDetails().get(i).getStname());
                                        resultBean.setNumber(orderFromDetail.getResult().getDetails().get(i).getNumber());
                                        resultBean.setCartNumber(orderFromDetail.getResult().getDetails().get(i).getNumber());
                                        resultBean.setDiscPrice(orderFromDetail.getResult().getDetails().get(i).getPrice());
                                        ...
                                        if (orderFromDetail.getResult().getDetails().get(i).getDisDyq()) {
                                            resultBean.setDisDyq(true);
                                        } else {
                                            resultBean.setDisDyq(false);
                                        }
                                        if (orderFromDetail.getResult().getDetails().get(i).getDisGwq()) {
                                            resultBean.setDisGwq(true);
                                        } else {
                                            resultBean.setDisGwq(false);
                                        }
                                        list.add(resultBean);
                                    }
                                    /**
                                    ...
                                    activityOrderformDetailBtnPay.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            ...
                                            intent.putParcelableArrayListExtra("payGoodsList", (ArrayList<CartGoodsbean.ResultBean>) list);
